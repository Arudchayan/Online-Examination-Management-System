            ...
            <div class="col-lg-6">
              <div class="input-container">
                <div class="inputInner-container">
                  <p class="input-title">Delete Module</p>
                  <form action="DeleteModule" method="post" name="userValidation" onSubmit="return userNameValidation(this)">
                    <div class="user-input">
                      <label class="input-label">Module Code</label>
                      <input type="text" name="Mcode" class="form-control" maxlength="6">
                    </div>
                    <input type="submit" class="input-btn btn btn-primary" value="Delete Module">
                  </form>
