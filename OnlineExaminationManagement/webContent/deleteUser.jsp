        ...
        <div class="row">
            <div class="col-lg-6">
              <div class="image-container">
                <img src="Images/delete.png" class="image-img">
              </div>
            </div>
            <div class="col-lg-6">
              <div class="input-container">
                <div class="inputInner-container">
                  <p class="input-title">Delete User</p>
                  <form action="DeleteUserServlet" method="post" name="userValidation" onSubmit="return userNameValidation(this)">
                    <div class="user-input">
                      <label class="input-label">User Name</label>
                      <input type="text"  name="userName" class="form-control" maxlength="6">
                    </div>
                    <input type="submit" class="input-btn btn btn-primary" value="Delete User">
                  </form>
